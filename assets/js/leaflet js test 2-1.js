//notes - MARKERS OUT OF DATE - SEVERAL MARKERS MUST be ADDED
...
const map = L.map('mapid').setView([31.2564, -91.9613], 7);
    ...
    map.on('zoomend', function() {
        ...
        FountainebleauRuinsIcon5min.seticonSize(currentZoom);
      });
...
var FountainebleauRuinsIcon5min = L.icon({
    iconUrl: 'Fountainebleau_radial.png',
...
var AlligatorMarshIcon5min = L.icon({
    iconUrl: 'AlligatorMarsh_radial.png',
...
var BayouLibertyRuinsIcon5min = L.icon({
    iconUrl: 'BayouLiberty_angled.png',
...
var FirstStCharlesIcon5min = L.icon({
    iconUrl: 'FirstStCharles_radial.png',
...
var MulattoBendCemeteryIcon5min = L.icon({
    iconUrl: 'MulattoBend_radial.png',
...
var BucktownBirdNestIcon5min = L.icon({
    iconUrl: 'BucktownBirdsNest_radial.png',
...
var PumpingStation1Icon5min = L.icon({
    iconUrl: 'PumpingStation1_radial.png',
...
var ChalmetteWetlandIcon5min = L.icon({
    iconUrl: 'ChalmetteWetland_radial.png',
...
var JacksonSquareIcon5min = L.icon({
    iconUrl: 'JacksonSquare_radial.png',
...
var BourbonStAnneIcon5min = L.icon({
    iconUrl: 'BourbonStAnn_radial.png',
...
var BourbonToulouseIcon5min = L.icon({
    iconUrl: 'BourbonToulouse_radial.png',
...
//marker definitions
L.marker([30.337159, -90.038018],{icon:FountainebleauRuinsIcon5min},{opacity:0.5}).addTo(map)
